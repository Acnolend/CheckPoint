...
data class UserName(
    ...
    companion object {
        ...
        const val ERROR_EMPTY = "No name? That's a problem!"
        const val ERROR_MIN_LENGTH = "Name too short! It must be at least $MIN_LENGTH characters!"
        const val ERROR_MAX_LENGTH = "Name too long! Keep it under $MAX_LENGTH characters, please!"
        const val ERROR_WRONG_FORMAT = "Oops! The name must start with a letter and end with a letter or number!"
    }
